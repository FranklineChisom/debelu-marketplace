...
import { adminNavItems, adminBottomNavItems } from "./navigation";
            ...
            >
                ...
                <div className="h-16 flex items-center px-4 lg:px-6 border-b border-border/50">
                    <div className="flex items-center gap-3 w-full">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-red-600 to-rose-600 flex items-center justify-center shadow-lg shadow-red-500/20">
                        ...
                        <div className={cn("flex-1 overflow-hidden transition-all duration-300", isCollapsed && "w-0 opacity-0 lg:hidden")}>
                            ...
                            <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-medium">Admin Portal</p>
                        </div>
                ...
                <div className="flex-1 flex flex-col gap-6 p-4 overflow-y-auto scrollbar-thin">
                    <nav className="space-y-1">
                        {!isCollapsed && (
                            <p className="px-4 text-[10px] uppercase tracking-wider text-muted-foreground font-bold mb-2">Management</p>
                        )}
